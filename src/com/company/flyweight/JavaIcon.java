...
public class JavaIcon extends AbstractIcon {
    ...
    JavaIcon() {
        URL iconURL =
                ClassLoader.getSystemResource("com/company/flyweight/images/source_java.png");
        if (iconURL != null) {
            icon = new ImageIcon(iconURL);
        } else {
            System.out.println("Icon com/company/flyweight/images/source_java.png not found");
        }
    }
