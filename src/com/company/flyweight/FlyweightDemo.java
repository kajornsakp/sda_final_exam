    ...
    implements MouseMotionListener
{
	...
	// COMPLETE.
        items = new ArrayList();
        items.add(new Item("dir","Folder",factory.createIcon("dir")));
        items.add(new Item("java","java",factory.createIcon("java")));
        items.add(new Item("java","java2",factory.createIcon("java")));
        items.add(new Item("pdf","pdf",factory.createIcon("pdf")));
        items.add(new Item("txt","txt",factory.createIcon("txt")));
        items.add(new Item("picture","picture",factory.createIcon("picture")));
        items.add(new Item("null","null",factory.createIcon(null)));
