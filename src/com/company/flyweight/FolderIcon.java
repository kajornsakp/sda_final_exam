...
public class FolderIcon extends AbstractIcon {
    ...
    FolderIcon() {
	URL iconURL =
	    ClassLoader.getSystemResource("com/company/flyweight/images/folder_open.png");
	if (iconURL != null) {
	    iconSel = new ImageIcon(iconURL);
	} else {
	    System.out.println("Icon com/company/flyweight/images/folder_open.png not found");
	}
	iconURL =
	    ClassLoader.getSystemResource("com/company/flyweight/images/folder.png");
	if (iconURL != null) {
	    iconUnsel = new ImageIcon(iconURL);
	} else {
	    System.out.println("Icon com/company/flyweight/images/folder.png not found");
	}
    }
